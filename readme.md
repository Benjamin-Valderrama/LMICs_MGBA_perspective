...
![<div style="text-align: justify"> **Figure 1: In the microbiome-gut-brain axis field, all income groups tend to collaborate more with HICs.** (A) Number of total publications in the microbiome-gut-brain axis field by each country. Shades of green represent the Log2 of total publications. (B) Number of international collaborations in the microbiome-gut-brain axis field by each country. Shades of green represent the Log2 of total international collaborations. In panels A and B, Grey depicts countries without information. (C) Proportion of total international collaborations with countries from the same income group. Grey dots are individual countries. Green dots and bar represent the mean ± SE of each income group. Vertical grey dotted line is the global median. While HICs collaborate among them, LMICs and UMICs collaborate with countries of other income groups. (D) Proportion of international collaborations across income groups and years. Collaborations between pairs of income groups are shown in separate panels. Shades of grey represent each income group. Green represents collaboration between both income groups shown in the panel. Over the years, collaborations between HICs and UMICs are more prevalent in the literature. However, collaborations between these groups and LMICs remain stagnant and represent a smaller fraction. HICs: High Income Countries, LMICs: Low- and Middle-Income Countries, UMICs: Upper-Middle Income Countries. </div>](outputs/figure1.jpg)
